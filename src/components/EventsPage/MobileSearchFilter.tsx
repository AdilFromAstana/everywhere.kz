...
interface MobileSearchFilterComponentProps {
    ...
    businessFields: any[];
    adPlacements: any[];
    setSelectedAdPlacements: React.Dispatch<React.SetStateAction<any[]>>;
    selectedAdPlacements: any[];
    setSelectedCities: React.Dispatch<React.SetStateAction<any[]>>;
    selectedCities: any[];
    setSelectedBusinessFields: React.Dispatch<React.SetStateAction<any[]>>;
    selectedBusinessFields: any[];
...
const MobileSearchFilter: React.FC<MobileSearchFilterComponentProps> = ({
    ...
    cities,
    businessFields,
    setSelectedAdPlacements,
    selectedAdPlacements,
    setSelectedBusinessFields,
    ...
    const handleCheckboxChange = (e: any, value: any, type: any) => {
        const handlers: any = {
            businessFieldCode: [selectedBusinessFields, setSelectedBusinessFields],
            adPlacementCode: [selectedAdPlacements, setSelectedAdPlacements],
    ...
    const renderCheckboxes = (items: any, type: any) => {
        const handlers: any = {
            businessFieldCode: selectedBusinessFields,
            adPlacementCode: selectedAdPlacements,
            ...
            <div className="flex flex-col gap-4">
                ...
                {lookingFor !== 'promoter' ? (
                    <div>
                        ...
                        <div className="space-y-2 max-h-[50vh] overflow-y-auto">
                            {renderCheckboxes(businessFields, 'businessFieldCode')}
                        </div>
                    </div>
                ) : null}
                <div>
                    ...
                    <div className="space-y-2">{renderCheckboxes(adPlacements, 'adPlacementCode')}</div>
                </div>
                <div>
                    <div className="text-lg font-bold mb-2 dark:text-white text-black">
