...
const SortButtons: React.FC<SortButtonsComponentProps> = ({ setSortOptions, sortOptions, locale }) => {
    const sortButtons: SortOptions[] = [
        { sortBy: 'date', sortOrder: 'desc', title: locale.EventListPage.SortButtons.SortFirstNewRealEstates },
        { sortBy: 'price', sortOrder: 'asc', title: locale.EventListPage.SortButtons.SortFirstCheapRealEstates },
        { sortBy: 'price', sortOrder: 'desc', title: locale.EventListPage.SortButtons.SortFirstExpensiveRealEstates },
    ];
