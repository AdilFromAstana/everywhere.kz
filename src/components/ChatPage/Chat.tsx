...
const Chat: React.FC = () => {
    ...
    const [realEstateId, setRealEstateId] = useState<any>(null);
    const [receiverId, setReceiverId] = useState<any>(null);
    const [realEstateTitle, setRealEstateTitle] = useState<any>(null);

    const handleSelectChat = (value: any) => {
        setSelectedChatId(value.id);
        setRealEstateId(value.RealEstate.id);
        setReceiverId(value.RealEstate.authorId);
        setRealEstateTitle(value.RealEstate.title);
    };
