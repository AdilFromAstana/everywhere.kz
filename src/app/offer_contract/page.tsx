        ...
        <div className="h100">
            ...
            <div className="flex flex-col">
                ...
                <div className="text-base my-2">
                    ...
                    осуществляется за минусом 2,5% от номинальной стоимости, сервисный сбор не возвращается, если обмен
                    и возврат билетов состоялся по желанию клиента не менее чем за 72 часа до начала мероприятия.
                    ...
                    Исполнителем по адресу: г. Алматы, ул. Наурызбай Батыра, д. 152А офис 4. При осуществлении возврата
                    билета на отмененные мероприятия производится возврат номинальной стоимости возвращенного билета, за
                    минусом сервисного сбора, если он применялся, а также стоимость доставки не возвращается.
                    <br />
                    6.3. При отмене, замене или переносе Мероприятия по инициативе Организатора возврат денег
                    осуществляется Исполнителю, зарегистрированному в заказе https://kazticket.kz/ по предъявлению
                    документа удостоверяющего личность и билета, на основании письменного заявления Заказчика. Срок
                    рассмотрения такого заявления 10 (Десять) рабочих дней с момента получения заявления.
                    <br />
                    ...
                    <br />
                    6.6. Полный возврат номинальной стоимости билета за минусом сервисного сбора и доставки Заказчику,
                    согласно п.6.5. возможен без каких либо объяснений со стороны Исполнителя, в случае полной отмены
                    Мероприятия Организатором.
                </div>
                <div className="text-base my-2">
        ...
        <div className="h100">
            ...
            <div className="flex flex-col">
                ...
                <div className="text-base my-2">
                    ...
                    are refunded minus 2.5% of the face value, the service charge is not refundable, if the exchange and
                    ...
                    Organizer the return shall be made by the Contractor at: Nur-Sultan, Rakymzhan Koshkarbayev Avenue,
                    ...
                    <br />
                    6.6 Full refund of the ticket's nominal value minus the service fee and delivery to the Customer,
        ...
        <div className="h100">
            ...
            <div className="flex flex-col">
                ...
                <div className="text-base my-2">
                    ...
                    номиналды құнының 2,5% алып тастағанда жүзеге асырылады, егер билеттерді айырбастау және қайтару
                    ...
                    Нұр-сұлтан қаласы, Рахымжан Қошқарбаев даңғылы, 27 ғимарат мекенжайы бойынша Орындаушы жүзеге
                    асырады. Тоқтатылған іс-шараларға билетті беру кезінде қайтарылған билеттің номиналды құны, егер ол
                    көрінсе, сервистік алымды шегергені үшін қайтарылады, сондай-ақ қол жеткізу құны қайтарылмайды.
                    <br />
                    ...
                    <br />
                    6.6. 6.5-тармаққа сәйкес Тапсырыс берушіге сервистік алым мен жеткізуді шегергендегі билеттің
