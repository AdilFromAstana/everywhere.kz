...
import { IEvent, IEventPageProps } from '@/interfaces/Interfaces';
import CardWrapper from '@/app/components/EventPage/Card';
...
export async function generateMetadata({ eventId }: IEventPageProps) {
  // const post = await getServerSideProps(params?.eventId);
  return {
    title: 'Название',
    description: 'desc',
  };
...
const Event: React.FC = async () => {
  ...
  const lgDescriptionTitle =
    'lg:text-4xl lg:flex lg:items-center lg:mt-16 lg:mb-8';
