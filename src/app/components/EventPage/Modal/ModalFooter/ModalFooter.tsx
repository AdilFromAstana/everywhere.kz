...
export const InfoTooltip: React.FC = () => {
  return (
    <div className='absolute inset-0 flex justify-center'>
      <div className='w-fit'>Вы отменили свой заказ!</div>
    </div>
  );
};
...
const SeatTooltip: React.FC = () => {
  ...
  return (
    <div
      id='tooltip'
      className='tooltipItem hidden rounded-lg border-2 border-black bg-white p-2 drop-shadow-2xl'
    >
      <div className='tooltipItem'>
        Вы действительно хотите завершить покупку билета?
      </div>
      <div className='tooltipItem mt-2 flex justify-end gap-2'>
        ...
        <button
          className='tooltipItem rounded-lg bg-blue-500 px-3 py-1 text-white'
          onClick={cancelOrder}
        >
          Да
        </button>
